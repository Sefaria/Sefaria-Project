    ...
    var centerContent = this.props.multiPanel && mode === "Connections" ?
      ...
      (React.createElement("div", {className: "readerTextToc", onClick: this.props.openMenu.bind(null, "text toc")}, 
          ...
          React.createElement("div", {className: "readerTextTocBox"}, 
           ...
           (this.props.version_language == "en" && this.props.settings.language == "english") ? (React.createElement("div", {className: "readerTextVersion"}, React.createElement("span", {className: "en"}, version_title))) : null
        ));
...
var ReaderNavigationMenu = React.createClass({displayName: "ReaderNavigationMenu",
  ...
  render: function() {
    if (this.props.categories.length) {
      ...
      var calendar = [(React.createElement(TextBlockLink, {sref: sjs.calendar.parasha, title: sjs.calendar.parashaName, heTitle: "פרשה", category: "Tanach"})),
                      (React.createElement(TextBlockLink, {sref: sjs.calendar.haftara, title: "Haftara", heTitle: "הפטרה", category: "Tanach"})),
...
var ReaderNavigationMenuSection = React.createClass({displayName: "ReaderNavigationMenuSection",
  propTypes: {
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "readerNavSection"}, 
        React.createElement("h2", null, 
          React.createElement("span", {className: "en"}, this.props.title), 
          React.createElement("span", {className: "he"}, this.props.heTitle)
        ), 
        this.props.content
      )
      );
...
var TextBlockLink = React.createClass({displayName: "TextBlockLink",
  ...
  render: function() {
    ...
    return (React.createElement("a", {className: classes, "data-ref": this.props.sref, "data-position": position, style: style}, 
              React.createElement("span", {className: "en"}, title), 
              React.createElement("span", {className: "he"}, heTitle)
             ));
  }
...
var BlockLink = React.createClass({displayName: "BlockLink",
  propTypes: {
    title:    React.PropTypes.string,
    heTitle:  React.PropTypes.string,
  ...
  render: function() { 
    return (React.createElement("a", {className: "blockLink", href: this.props.target}, 
              React.createElement("span", {className: "en"}, this.props.title), 
              React.createElement("span", {className: "he"}, this.props.heTitle)
           ));
  }
...
var ReaderTextTableOfContents = React.createClass({displayName: "ReaderTextTableOfContents",
  ...
  render: function() {
    ...
    var selectOptions = [];
    selectOptions.push(React.createElement("option", {key: "0", value: "0"}, "Default Version"));    // todo: add description of current version.
...
var ReaderNavigationMenuSearchButton = React.createClass({displayName: "ReaderNavigationMenuSearchButton",
  render: function() { 
    return (React.createElement("span", {className: "readerNavMenuSearchButton", onClick: this.props.onClick}, React.createElement("i", {className: "fa fa-search"})));
  }
});
...
var SearchResultList = React.createClass({displayName: "SearchResultList",
    ...
    render: function () {
        ...
        return (
            React.createElement("div", null, 
                React.createElement("div", {className: "results-count", key: "results-count"}, 
...
var AccountPanel = React.createClass({displayName: "AccountPanel",
  render: function() {
    ...
    var accountContent = [
      (React.createElement(BlockLink, {target: "/my/profile", title: "Profile"})),
      (React.createElement(BlockLink, {target: "/sheets/private", title: "Source Sheets"})),
      (React.createElement(BlockLink, {target: "#", title: "Reading History"})),
      (React.createElement(BlockLink, {target: "#", title: "Notes"})),
      (React.createElement(BlockLink, {target: "/settings/account", title: "Settings"}))
    ];
    accountContent = (React.createElement(TwoOrThreeBox, {content: accountContent, width: width}));

    var learnContent = [
      (React.createElement(BlockLink, {target: "/about", title: "About"})),
      (React.createElement(BlockLink, {target: "/faq", title: "FAQ"})),
      (React.createElement(BlockLink, {target: "http://blog.sefaria.org", title: "Blog"})),
      (React.createElement(BlockLink, {target: "/educators", title: "Educators"})),
      (React.createElement(BlockLink, {target: "/help", title: "Help"})),
      (React.createElement(BlockLink, {target: "/team", title: "Team"}))
    ];
