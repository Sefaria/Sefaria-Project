...
var ReaderNavigationMenu = React.createClass({displayName: "ReaderNavigationMenu",
  ...
  render: function() {
    if (this.props.categories.length) {
      ...
      calendar = (React.createElement("div", {className: "readerNavCalendar"}, React.createElement(TwoOrThreeBox, {content: calendar, width: this.width})));
      ...
      if (this.state.currentVersion.merged) {
        ...
        currentVersionElement = (
          React.createElement("span", {className: "currentVersionInfo"}, 
            React.createElement("span", {className: "currentVersionTitle"}, "Merged from ",  uniqueSources ), 
