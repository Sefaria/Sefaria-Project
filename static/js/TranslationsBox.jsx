...
const translationBoxShoulDUpdate = (prevProps, nextProps) => {
  // Only update if the vFilter has changed
  return nextProps.vFilter.compare(prevProps.vFilter)
};

export default memo(TranslationsBox, translationBoxShoulDUpdate);
