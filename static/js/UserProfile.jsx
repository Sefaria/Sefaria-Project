 ...
 return (
   ...
   <div className="editorToggleHeader sans-serif">{text}
     <a href="#" onClick={()=>toggleFeedbackOverlayState()} className="button white" role="button">{buttonText}</a>
       <a href={learn_more_link} data-attr-module={Sefaria.SHEETS_MODULE} className="learnMore"><InterfaceText>Learn More</InterfaceText></a>
   </div>
...
const ProfileSummary = ({
    ...
    const profileButtons = Sefaria._uid === p.id ? (
                                    <div className="profile-actions">
                                        <a href="/settings/profile" className="resourcesLink sans-serif" data-attr-module={Sefaria.SHEETS_MODULE}>
    ...
    const tempSheetButton = (
          <a href="/sheets/new" className="resourcesLink sans-serif" data-attr-module={Sefaria.SHEETS_MODULE}>
  ...
  const tempCollectionButton = (
          <a href="/sheets/collections/new" className="resourcesLink sans-serif" data-attr-module={Sefaria.SHEETS_MODULE}>
