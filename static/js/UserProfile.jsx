...
const EditorToggleHeader = ({usesneweditor}) => {
 ...
 const enableOverlayContent = (
   <div class="sans-serif-in-hebrew">
      ...
      <div className="buttonContainer"><a href="/enable_new_editor" onClick={()=>toggleFeedbackOverlayState()} className="sefaria-common-button legacy"><InterfaceText>Back to Profile</InterfaceText></a></div>
   </div>
 )
 const thankYouContent = (
   <div class="sans-serif-in-hebrew">
      ...
      <div className="buttonContainer"><a href="/disable_new_editor" className="sefaria-common-button legacy"><InterfaceText>Back to Profile</InterfaceText></a></div>
   </div>
 )
 ...
 return (
   ...
   <div className="editorToggleHeader sans-serif">{text}
     <a href="#" onClick={()=>toggleFeedbackOverlayState()} className="sefaria-common-button legacy white">{buttonText}</a>
