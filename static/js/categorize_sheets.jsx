  ...
  render() {
    ...
    return (
      <div className="categorizer">
        <div id="edit-pane">
          <h3>{Sefaria._("topic.topics_or_tags")} </h3>
          ...
          <div className="categorize-section">
            ...
            ></input>
            <label htmlFor="noTags">{Sefaria._("topic_no_tags")}</label>
          </div>
          <div className="categorize-section">
            <fieldset>
            ...
            <input type="text" key="newCategory" id="newCategory" placeholder={Sefaria._("sheet.new_category")} onKeyUp={this.addCategory.bind(this)}></input><button onClick={this.addCategory.bind(this)}>{Sefaria._("button.add")} </button>
          </div>
          ...
          <div className="left-pane-bottom">
            ...
            <div>
            <button onClick={this.skipAndNext.bind(this)}>{ Sefaria._("sheet.skit_sheet")} </button>
            </div>
            { Sefaria._("sheet.message.sheet_will_save")}
          </div>
        </div>
