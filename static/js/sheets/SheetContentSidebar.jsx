    ...
    const renderItems = () => {
      if (type === "topics") {
        return items.map((item, i) => (
            <li key={i}><a
                href={"/sheets/topics/" + item.slug} data-attr-module="sheets"><InterfaceText text={{en: item.en, he: item.he}}></InterfaceText></a>
            </li>
        ))
      } else {
        return items.map((item, i) => (
            <li key={i}><a
                href={"/sheets/collections/" + item.slug} data-attr-module="sheets"><InterfaceText>{item.name}</InterfaceText></a>
            </li>
        ))
      }
    }
