...
const GDocAdvertText = () => {
    ...
    return    <InterfaceText>
                <EnglishText> Add texts directly to your Google Docs with our <span id="newExtension">new extension</span>! <a href={learnMoreLink} data-attr-module={Sefaria.SHEETS_MODULE}>Learn more</a></EnglishText>
                <HebrewText> הוסיפו טקסטים מספריא ישירות לקובץ גוגל עם <span id="newExtension">התוסף החדש</span> שלנו! <a href={learnMoreLink} data-attr-module={Sefaria.SHEETS_MODULE}>למדו עוד</a></HebrewText>
             </InterfaceText>;
}
