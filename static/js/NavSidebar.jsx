  ...
  <Module>
    ...
    <InterfaceText>
      ...
      and commentaries so that everyone can participate in the ongoing process of studying, interpreting, and creating Buddhist text library.
        ...
        <HebrewText>
        དཔེ་ཆ་དྲ་ཚིགས་ནི་༢༥༠༠རིང་གི་ནང་ཆོས་དཔེ་དེབ་ཉར་ཚགས་བྱེད་ས་ཞིག་ཡིན་ ང་ཚོས་དྲ་རྒྱ་འདི་བརྒྱུད་ཁྱེད་རྣམས་ལ་ཡི་གེ་དང་ཡིག་སྒྱུར་དེ་བཞིན་མཆན་འགོད་ཀྱི་ཁྱད་ཆོས་བསྐྲུན་ཡོད་པས་ཚང་མས་སྦྱོང་བ་དང་གསར་བཟོ་བྱས་ཏེ་དྲ་རྒྱའི་དཔེ་མཛོད་ཞིག་བཟོ་ཐུབས་
        </HebrewText>
    </InterfaceText>
...
const Resources = () => (
  <Module>
    ...
    <div className="linkList">
      ...
      <IconLink text="Teach with Pecha" url="/educators" icon="educators.svg" />
