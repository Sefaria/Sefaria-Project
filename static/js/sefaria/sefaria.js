...
Sefaria = extend(Sefaria, {
  ...
  ISOMap: {
    ...
    "es": {"name": "Spanish", "i18nString": "language.spanish", "showTranslations": 1},
    "fr": {"name": "French", "i18nString": "language.french", "showTranslations": 1},
    "de": {"name": "German", "i18nString": "language.german", "showTranslations": 1},
    "ar": {"name": "Arabic", "i18nString": "language.arabic", "showTranslations": 1},
    "it": {"name": "Italian", "i18nString": "language.italian", "showTranslations": 1},
    "pl": {"name": "Polish", "i18nString": "language.polish", "showTranslations": 1},
    "ru": {"name": "Russian", "i18nString": "language.russian", "showTranslations": 1},
    "eo": {"name": "Esperanto", "i18nString": "language.esperanto", "showTranslations": 1},
    ...
    "el": {"name": "Greek", "i18nString": "language.greek", "showTranslations": 1},
    ...
    "sk": {"name": "Slovak", "i18nString": "language.slovak", "showTranslations": 1},
    "hu": {"name": "Hungarian", "i18nString": "language.hungarian", "showTranslations": 1},
    "ro": {"name": "Romanian", "i18nString": "language.romanian", "showTranslations": 1},
    "bg": {"name": "Bulgarian", "i18nString": "language.bulgarian", "showTranslations": 1},
    "sr": {"name": "Serbian", "i18nString": "language.serbian", "showTranslations": 1},
    "hr": {"name": "Croatian", "i18nString": "language.croatian", "showTranslations": 1},
    "bs": {"name": "Bosnian", "i18nString": "language.bosnian", "showTranslations": 1},
    "sq": {"name": "Albanian", "i18nString": "language.albanian", "showTranslations": 1},
    "lt": {"name": "Lithuanian", "i18nString": "language.lithuanian", "showTranslations": 1},
    "lv": {"name": "Latvian", "i18nString": "language.latvian", "showTranslations": 1},
    "et": {"name": "Estonian", "i18nString": "language.estonian", "showTranslations": 1},
    "hy": {"name": "Armenian", "i18nString": "language.armenian", "showTranslations": 1},
    "ka": {"name": "Georgian", "i18nString": "language.georgian", "showTranslations": 1},
    "kk": {"name": "Kazakh", "i18nString": "language.kazakh", "showTranslations": 1},
    "uz": {"name": "Uzbek", "i18nString": "language.uzbek", "showTranslations": 1},
    "tt": {"name": "Tatar", "i18nString": "language.tatar", "showTranslations": 1},
    "ta": {"name": "Tamil", "i18nString": "language.tamil", "showTranslations": 1},
    "te": {"name": "Telugu", "i18nString": "language.telugu", "showTranslations": 1},
    "kn": {"name": "Kannada", "i18nString": "language.kannada", "showTranslations": 1},
    "ml": {"name": "Malayalam", "i18nString": "language.malayalam", "showTranslations": 1},
    "pa": {"name": "Punjabi", "i18nString": "language.punjabi", "showTranslations": 1},
    "mr": {"name": "Marathi", "i18nString": "language.marathi", "showTranslations": 1},
    "gu": {"name": "Gujarati", "i18nString": "language.gujarati", "showTranslations": 1},
    "si": {"name": "Sinhala", "i18nString": "language.sinhala", "showTranslations": 1},
    "ne": {"name": "Nepali", "i18nString": "language.nepali", "showTranslations": 1},
    "my": {"name": "Burmese", "i18nString": "language.burmese", "showTranslations": 1},
    "km": {"name": "Khmer", "i18nString": "language.khmer", "showTranslations": 1},
    "lo": {"name": "Laotian", "i18nString": "language.laotian", "showTranslations": 1},
    "mn": {"name": "Mongolian", "i18nString": "language.mongolian", "showTranslations": 1},
    "eu": {"name": "Basque", "i18nString": "language.basque", "showTranslations": 1},
    "gl": {"name": "Galician", "i18nString": "language.galician", "showTranslations": 1},
    "cy": {"name": "Welsh", "i18nString": "language.welsh", "showTranslations": 1},
    "ga": {"name": "Irish", "i18nString": "language.irish", "showTranslations": 1},
    "sco": {"name": "Scots", "i18nString": "language.scots", "showTranslations": 1},
    "is": {"name": "Icelandic", "i18nString": "language.icelandic", "showTranslations": 1},
    "mt": {"name": "Maltese", "i18nString": "language.maltese", "showTranslations": 1},
    "sl": {"name": "Slovenian", "i18nString": "language.slovenian", "showTranslations": 1},
    "mk": {"name": "Macedonian", "i18nString": "language.macedonian", "showTranslations": 1},
    "sr-ME": {"name": "Montenegrin", "i18nString": "language.montenegrin", "showTranslations": 1},
    "se": {"name": "Sami", "i18nString": "language.sami", "showTranslations": 1},
    "fo": {"name": "Faroese", "i18nString": "language.faroese", "showTranslations": 1},
    "kl": {"name": "Greenlandic", "i18nString": "language.greenlandic", "showTranslations": 1},
    "fy": {"name": "Frisian", "i18nString": "language.frisian", "showTranslations": 1},
    "az": {"name": "Azeri", "i18nString": "language.azeri", "showTranslations": 1},
    "oc": {"name": "Occitan", "i18nString": "language.occitan", "showTranslations": 1},
    "dz": {"name": "Bhutanese", "i18nString": "language.bhutanese", "showTranslations": 1}
}
,
  translateISOLanguageCode(code, native = true) {
    //takes two-letter ISO 639.2 code and returns full language name
    const lookupVar = native ? "i18nString" : "name";
...
_media: {},
  ...
  hebrewTranslation: function(inputStr, context = null){
    ...
    // }
    if ((translatedString = Sefaria._getStringCaseInsensitive(Sefaria['localizationStrings'][Sefaria.interfaceLang], inputStr)) !== null ) {
  ...
  translation: function(language, inputStr, context=null){
      ...
      try {
          ...
          console.log(language, inputStr)
          console.warn("No transaltion available for " + language, inputStr)
          return inputStr;
      }
  },
  ...
  _cacheSiteInterfaceStrings: function() {
    ...
    ["SITE_NAME", "LIBRARY_NAME"].map(key => {
      Sefaria['localizationStrings'][Sefaria.interfaceLang][Sefaria._siteSettings[key]["en"]] = Sefaria._siteSettings[key]["he"];
    });
  },
