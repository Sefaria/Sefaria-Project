// A countryMode of "all" matches every viewer. "include" matches if any candidate country is in the
// target list. "exclude" matches if any candidate country falls OUTSIDE the target list -- consistent
// with maximizing recall: a viewer is excluded only once every plausible candidate is on the list.
