...
const Strings = {
  _i18nInterfaceStrings: {
    // --- Authentication / Login & Registration (spec 1602) — strings from Penina's sheet ---
    "Sign In": "התחברות",
    "or": "או",
    "Password": "סיסמה",
    ...
    "Password Reset Successfully": "סיסמה עודכנה בהצלחה",
    "New Password": "סיסמה חדשה",
    "Confirm New Password": "אימות סיסמה חדשה",
    "Don't have an account?": "אין לך חשבון?",
    "Already have an account?": "יש לך חשבון?",
    "Check your email and follow the instructions to reset your password.": "שלחנו לך הוראות לעדכון הסיסמה לתיבת האימייל שלך.",
    "Your password was reset successfully. Now you can use it to sign in.": "הסיסמה עודכנה בהצלחה. אפשר להתחבר עכשיו.",
    "By continuing, you are agreeing to Sefaria's Terms of Use and Privacy Policy.": "התקדמות בתהליך מהווה הסכמה לתנאי שימוש ומדיניות פרטיות של ספריא.",
    "Email and/or password are incorrect": "אימייל ו/או הסיסמה אינם נכונים",
    ...
    "Back": "חזרה",
    "Show password": "הצגת סיסמא",
    "Hide password": "הסתרת סיסמא",
