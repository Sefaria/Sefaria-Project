const Strings = {
  _i18nInterfaceStrings: {
    ...
    "Discover": "גלה",
    "Readings": "קריאות",
    "Recently Published": "פורסם לאחרונה",
    "Load More": "טען עוד",
    "Join the Conversation": "להצטרף לשיחה" ,
    "Make a Sheet": "צור דף חדש",
    "Combine sources from our library with your own comments, questions, images, and videos.": "שלב מקורות מהספרייה שלנו עם הערות, שאלות, תמונות וסרטונים משלך.",
    "A Living Library of Torah": "ספרייה חיה של תורה",
    "Sefaria is home to 3,000 years of Jewish texts. We are a non-profit organization offering free access to texts, translations, and commentaries so that everyone can participate in the ongoing process of studying and interpreting Torah.": "בספריא חיים 3,000 שנה של טקסטים יהודיים. אנו ארגון ללא מטרות רווח המציע גישה חופשית לטקסטים, תרגומים ופרשנויות, כך שכולם יוכלו להשתתף בתהליך המתמשך של לימוד ופרשנות התורה.",
    "Learn More": "לקריאה נוספת",
    "Explore the Library": "חקור את הספרייה",
    "Study Schedules": "לוחות זמנים ללימוד",
    "Teach with Sefaria": "לַמדו עם ספריא",
    "Visualizations": "תרשימים גרפיים",
    "Torah Tab": "תורה טאב",
    "Get the Mobile App": "קבל את האפליקציה לנייד",
    "Access the Jewish library anywhere and anytime with": "גש לספרייה היהודית בכל מקום ובכל זמן באמצעות",
    "the Sefaria mobile app.": "אפליקציית ספריא לנייד.",
    "Stay Connected": "השארו מעודכנים",
    "Get updates on new texts, learning resources, features, and more.": "קבל עדכונים על טקסטים חדשים, משאבי למידה, תכונות ועוד.",
    "Support Sefaria": "תמכו בספריא",
    "Sefaria is an open source, non-profit project. Support us by making a tax-deductible donation.": "ספריא הוא פרויקט קוד פתוח, ללא מטרות רווח. תמכו בנו באמצעות תרומה בניכוי מס.",
