 ...
 */
const FormView = ({ cardClass, onBack, heading, sub, formId, onProviderClick, onLinkClick, onSubmit, children }) => {
  ...
  return (
    <AuthCard className={cardClass} onBack={onBack} heading={heading} sub={sub}>
      <form id={formId} className="sefaria-auth-email-form" onSubmit={handleSubmit} noValidate>
        <ErrorBanner error={error} onProviderClick={onProviderClick} onLinkClick={onLinkClick} />
