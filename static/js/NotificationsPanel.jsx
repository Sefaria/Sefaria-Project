...
const SheetPublishNotification = ({date, content}) => {
  const topLine = (
    <>
      <a href={content.profileUrl} data-attr-module="sheets" className="notificationUserName">{content.name}</a>&nbsp;
  ...
  const body = (
    <>
      <a className="sheetTitle" href={"/sheets/" + content.sheet_id} data-attr-module="sheets">{content.sheet_title}</a>
      {content.summary ?
...
const CollectionAddNotification = ({date, content}) => {
  ...
  const body = (
    <>
      <a className="collectionName" data-attr-module="sheets" href={"/sheets/collections/" + content.collection_slug}>
