...
const TopicEditor = ({origData, onCreateSuccess, close, origWasCat=false}) => {
    ...
    const [isNew, setIsNew] = useState(Object.keys(origData).length === 1 && "origEn" in origData);
    ...
    const handleCatChange = function(e) {
      ...
      //logic is: if it starts out with origWasCat is true, isTopicCategory should always be true, otherwise, it should depend solely on 'Main Menu'
      const newIsTopicCategory = origWasCat || e.target.value === Sefaria._("Main Menu");
