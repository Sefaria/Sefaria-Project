    ...
    return (<div className="aboutSheetPanel">
        ...
        <div className="aboutSheetMetadata">
            <div>
                ...
                />
                <span>{Sefaria.interfaceLang == 'hebrew'? sheet.views : sheet.views}</span>
                <span>{Sefaria.interfaceLang == 'hebrew'? sheetSaves.length  : sheetSaves.length } {Sefaria._("common.saves")}</span>
            </div>
