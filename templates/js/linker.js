...
(function(ns){
    ...
    ns.link = function(selector) {
        ...
        for (var i = 0; i < elems.length; i++) {
            ...
            var enBooks = elems[i].innerHTML.match(enBooksRe);
            var heBooks = elems[i].innerHTML.match(heBooksRe);
            if (enBooks) bookNames = bookNames.concat(enBooks);
            if (heBooks) bookNames = bookNames.concat(heBooks);
        }
