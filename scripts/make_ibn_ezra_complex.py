...
if __name__ == "__main__":
    ...
    prelude.add_primary_titles("Prelude", u"פתיחה")
    insert_first_child(prelude, parent_node)
    addenda = JaggedArrayNode()
    addenda.add_primary_titles("Addenda", u"הוספות")
    ...
    translator.add_primary_titles("Translators Foreword", u"הקדמת המתרגם")
