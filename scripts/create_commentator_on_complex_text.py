...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "existing_book", help="title of existing index record for the comemntary"
    )
    ...
    parser.add_argument(
        "-ht", "--he_commentator_name", help="version source for the new version"
    )
    ...
    try:
        ...
        create_commentator_and_commentary_version(
            args.commentator_name,
            args.existing_book,
            args.language,
            args.version_title,
            args.version_source,
            args.he_commentator_name,
        )
