...
kos_version = Version().load(
    {
        "versionTitle": "Rabbi Mark Greenspan",
        "title": "Kos Shel Eliyahu on Haggadah",
        "language": "en",
    }
)
...
merge_text_versions(
    ...
    "Rabbi Mark Greenspan B",
    "Kos Shel Eliyahu on Pesach Haggadah",
    "en",
)
...
rebuild_commentary_links(
    "Kos Shel Eliyahu on Haggadah", 8646
)  # should also work to remove all the wrong ones
#####

# Yismach Yisrael######
rebuild_commentary_links("Yismach Yisrael on Pesach Haggadah", 8646)
rebuild_commentary_links(
    "Yismach Yisrael on Haggadah", 8646
)  # will delete the old ones
#####
...
# Maase Nissim
Index().load(
    {"title": "Maaseh Nissim on Haggadah"}
).delete()  # delete errant index record. The rest is fine
