    ...
    for source in sources:
        if "text" in source:
            for lang in source["text"]:
                ...
                if (
                    source["text"][lang] != None
                    and "font-family" in source["text"][lang]
                ):
                ...
                if (
                    source["text"][lang] != None
                    and "background-color:#" in source["text"][lang]
                ):
            ...
            for lang in source["outsideBiText"]:
                if (
                    source["outsideBiText"][lang] != None
                    and "font-size" in source["outsideBiText"][lang]
                ):
                    sheets_with_resized_text.add(sheet["id"])
                if (
                    source["outsideBiText"][lang] != None
                    and "font-family" in source["outsideBiText"][lang]
                ):
                    sheets_with_changed_fonts.add(sheet["id"])
                if (
                    source["outsideBiText"][lang] != None
                    and "<table" in source["outsideBiText"][lang]
                ):
                    sheets_with_tables.add(sheet["id"])
                if (
                    source["outsideBiText"][lang] != None
                    and "<strong" in source["outsideBiText"][lang]
                ):
                    sheets_with_bold.add(sheet["id"])
                if (
                    source["outsideBiText"][lang] != None
                    and "<em" in source["outsideBiText"][lang]
                ):
                    sheets_with_italics.add(sheet["id"])
                if (
                    source["outsideBiText"][lang] != None
                    and "background-color:#" in source["outsideBiText"][lang]
                ):
                    sheets_with_bg_color.add(sheet["id"])
                if (
                    source["outsideBiText"][lang] != None
                    and "color:#" in source["outsideBiText"][lang]
                ):
                    sheets_with_font_color.add(sheet["id"])
            ...
            if source["outsideText"] != None and "<em" in source["outsideText"]:
                sheets_with_italics.add(sheet["id"])
            if (
                source["outsideText"] != None
                and "background-color:#" in source["outsideText"]
            ):
                sheets_with_bg_color.add(sheet["id"])
