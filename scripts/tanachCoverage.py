...
tanach_books = (
    library.get_indexes_in_category("Torah")
...
print(
    "Each book of Tanach, the verses in it that are referred in the Bavli, the total verses in the book, and the percentage of total book referenced in Bavli."
)
print()
...
print()
print(
    "Verses with more than one reference: {}".format(
        len({a: b for a, b in freqs.items() if b > 1})
    )
)
print()
