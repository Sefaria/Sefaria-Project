...
default_version_title_cantillation = "Tanach with Ta'amei Hamikra"
...
new_version_title_cantillation = "Westminster Leningrad Codex"
...
update_version_title(default_version_title_cantillation, rename_version_title_cantillation, language)
print "changing old taamei hamikra history"
update_version_title_in_history(default_version_title_cantillation, rename_version_title_cantillation, language)
...
update_version_title(new_version_title_cantillation, default_version_title_cantillation, language)
update_version_title_in_history(new_version_title_cantillation, default_version_title_cantillation, language)
...
db.texts.update({"versionTitle": default_version_title_cantillation, "language": language}, {"$set": {"status": "locked", "priority":1}}, upsert=False, multi=True, writeConcern={ 'w': 1 })
