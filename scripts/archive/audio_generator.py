...
class Queue(object):
    ...
    def passuk_counter(self):
        ...
        for book in range(len(sefarim)):
            ...
            while reference != None:
                ...
                try:
                    data = requests.get(
                        "https://www.sefaria.org/api/texts/" + reference + "?context=0"
                    )
                except:
                    continue
                resp = data.json()
    ...
    def aliyot(self):
        ...
        f = open(
            "C:/Users/Tamar Yastrab/Documents/Sefaria-Project/tamars_work/parsha_aliyot3.txt",
            "rt",
        )
        content = f.read()
    ...
    def file_opener(self, parshiyot):
        for parsha in parshiyot:  # for each parsha
            ...
            while aliyah < 7:  # look at aliyot 0-6
                ...
                f = open(
                    "C:/Users/Tamar Yastrab/Documents/PocketTorah/data/torah/labels/"
                    + parsha2
                    + "-"
                    + str(aliyah + 1)
                    + ".txt",
    ...
    def dictionary_maker(self, tag, holder, aliyot, num_verses):
        ...
        while (
            cur_verse < int(num_verses) - 1
        ):  # while we haven't found all of the pessukim in the aliyah
        ...
        time_stamps[(self.__que[self.__front])[0]] = (
            holder[start_time],
            holder[last_passuk - 1].strip(),
        )
        self.remove()
        title = tag + "-" + aliyot
