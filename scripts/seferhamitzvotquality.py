...
def change_collective_titles(titles, he_titles):
    for title, he_title in zip(titles, he_titles):
        ...
        print(
            "Changing {}'s collective title to {}".format(title, index.collective_title)
        )
        index.save()
...
if __name__ == "__main__":
    ...
    print(
        "Refreshing version states, cache, TOC, and deleting empty category Hasagot HaRamban..."
    )
    for title in titles:
        title = title.replace(" al ", " on ").replace("Hamitzvot", "HaMitzvot")
