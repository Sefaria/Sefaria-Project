    ...
    for source in sources:
        if "outsideBiText" in source:
            try:
                ...
                if (
                    source["outsideBiText"]["en"] == None
                    or strip_tags(source["outsideBiText"]["en"]) == ""
                ):
                    ...
                    source["outsideBiText"]["he"] == None
                    or strip_tags(source["outsideBiText"]["he"]) == ""
                ):
                    ...
                    source["outsideBiText"]["en"] != None
                    and strip_tags(source["outsideBiText"]["en"]) == "English"
                ):
                    source["outsideText"] = source["outsideBiText"]["he"]
                    del source["outsideBiText"]
                    ...
                    source["outsideBiText"]["he"] != None
                    and strip_tags(source["outsideBiText"]["he"]) == "עברית"
                ):
                    source["outsideText"] = source["outsideBiText"]["en"]
                    del source["outsideBiText"]
...
print("****************************")
print(
    "sheets_with_default_en_in_outsideBiText_en:"
    + str(len(sheets_with_default_en_in_outsideBiText_en))
)
print("****************************")
print(
    "sheets_with_default_he_in_outsideBiText_he:"
    + str(len(sheets_with_default_he_in_outsideBiText_he))
)
print("****************************")
print(
    "sheets_with_empty_outsideBiText_en:" + str(len(sheets_with_empty_outsideBiText_en))
)
print("****************************")
print(
    "sheets_with_empty_outsideBiText_he:" + str(len(sheets_with_empty_outsideBiText_he))
)
print("****************************")
