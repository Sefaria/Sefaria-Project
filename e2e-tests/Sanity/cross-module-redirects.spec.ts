...
test.describe('Cross-Module Redirects (Library to vouces) - 301 Status Codes', { tag: '@sanity' }, () => {
  ...
  test('Settings Profile Returns 301 Permanent Redirect', async ({ page }) => {
    ...
    await page.goto(`${MODULE_URLS.EN.LIBRARY}/settings/profile`, { waitUntil: 'domcontentloaded' });
  ...
  test('Community Returns 301 Permanent Redirect', async ({ page }) => {
    ...
    await page.goto(`${MODULE_URLS.EN.LIBRARY}/community`, { waitUntil: 'domcontentloaded' });
