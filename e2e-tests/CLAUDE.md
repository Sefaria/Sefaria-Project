...
10. **Read the React component before writing locators in a new feature area.** Source lives under `Sefaria-Project-Master/static/js/`. Five minutes reading the component that owns the DOM you're testing saves thirty minutes of guessing. Skip this step only when your test reuses existing POM methods unchanged — for any new POM method or new feature area, read the source first.
