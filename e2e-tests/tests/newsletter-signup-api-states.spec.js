 ...
 *
 * Removed: the "fallback to 6 default newsletters on lists API failure" test.
 * The form no longer renders the NEWSLETTERS constant when the backend is
 * unavailable — `setServiceUnavailable(true)` now short-circuits the form and
 * shows a "not available right now" message instead.
 */
