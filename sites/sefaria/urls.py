...
site_urlpatterns += [
    ...
    url(r'^faq/?$', lambda x: HttpResponseRedirect('/hc/en-us' if x.interfaceLang == 'english' else '/hc/he')),
    url(r'^help/?$', lambda x: HttpResponseRedirect('/hc/en-us' if x.interfaceLang == 'english' else '/hc/he')),
