...
site_urlpatterns += [
    ...
    url(r'^faq/?$', lambda x: HttpResponseRedirect('https://help.sefaria.org/hc/en-us' if x.interfaceLang == 'english' else 'https://help.sefaria.org/hc/he')),
    url(r'^help/?$', lambda x: HttpResponseRedirect('https://help.sefaria.org/hc/en-us' if x.interfaceLang == 'english' else 'https://help.sefaria.org/hc/he')),
