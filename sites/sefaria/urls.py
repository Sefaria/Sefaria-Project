...
site_urlpatterns += [
    ...
    url(r'^faq/?$', lambda x: HttpResponseRedirect('/collections/help-center' if x.interfaceLang == 'english' else '/collections/help-center')),
    url(r'^help/?$', lambda x: HttpResponseRedirect('/collections/help-center' if x.interfaceLang == 'english' else '/collections/help-center')),
