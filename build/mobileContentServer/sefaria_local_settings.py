...
# The production version is stored in our infrastructure repository
...
DATABASES = {
    'default': {
        ...
        'NAME': '/app/data/db.sqlite', # Or path to database file if using sqlite3.
...
CACHES = {
    "shared": {
        ...
        "LOCATION": "redis://redis-prod1:6379/1", #The URI used to look like this "127.0.0.1:6379:0"
        "OPTIONS": {
    ...
    "default": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://redis-prod1:6379/0", #The URI used to look like this "127.0.0.1:6379:0"
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
...
# password = urllib.quote_plus("i2TTcI8^*^@s")
MONGO_HOST = 'mongo'
MONGO_PORT = 27017
...
SEFARIA_DATA_PATH = ''  # used for Data
SEFARIA_EXPORT_PATH = ''  # used for exporting texts
...
AWS_ACCESS_KEY = ""
AWS_SECRET_KEY = ""
S3_BUCKET = "sefaria-user-content"
