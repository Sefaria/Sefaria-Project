...
def base_props(request):
    ...
    if request.user.is_authenticated:
        ...
        user_data = {
            ...
            "translation_language_preference": profile.settings.get("translation_language_preference", "english"),
        ...
        user_data = {
            ...
            "translation_language_preference": request.COOKIES.get("translation_language_preference", "english"),
            "following": [],
