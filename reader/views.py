...
def data_props(request):
    ...
    return {
          ...
          "books":               json.loads(library.get_text_titles_json()),
          ...
          "notifications":       json.loads(user_and_notifications_dict.get("notifications_json", '[]')),
          ...
          "interruptingMessage": json.loads(user_and_notifications_dict.get("interrupting_message_json")),
