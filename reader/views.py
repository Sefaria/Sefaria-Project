...
if ENABLE_LINKER:
    ...
    logger.info(f"LD_LIBRARY_PATH {os.environ.get('LD_LIBRARY_PATH', 'N/A')}")
    logger.info(f"LD_PRELOAD {os.environ.get('LD_PRELOAD', 'N/A')}")
    logger.info(f"LIBRARY_PATH {os.environ.get('LIBRARY_PATH', 'N/A')}")
