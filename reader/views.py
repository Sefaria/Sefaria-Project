...
from remote_config.keys import CHATBOT_MAX_INPUT_CHARS, CHATBOT_MAX_PROMPTS, CHATBOT_PROMO_LEARN_MORE_URLS, CHATBOT_PROMO_SESSION_LENGTH, SHOW_JOIN_CHATBOT_BANNER
...
def base_props(request):
    ...
    chatbot_data = {
        ...
        'chatbot_promo_session_length': remoteConfigCache.get(CHATBOT_PROMO_SESSION_LENGTH, default=None),
