...
class APIRefTests(SefariaTestCase):
    ...
    def test_one_level_below_book(self):
        ...
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Penei Moshe on Jerusalem Talmud Shabbat')
    ...
    def test_two_levels_below_book(self):
        ...
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Penei Moshe on Jerusalem Talmud Shabbat 3')
    ...
    def test_section_level(self):
        ...
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Penei Moshe on Jerusalem Talmud Shabbat 2:3')
    ...
    def test_range_halakhah_level(self):
        ...
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Penei Moshe on Jerusalem Talmud Shabbat 3-4')
        self.assertNotIn('first_subref', data['navigation_refs'])
        self.assertNotIn('prev_section_ref', data['navigation_refs'])
        self.assertNotIn('next_section_ref', data['navigation_refs'])
        self.assertNotIn('prev_segment_ref', data['navigation_refs'])
    ...
    def test_range_section_level(self):
        ...
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Penei Moshe on Jerusalem Talmud Shabbat 3:2-4:1')
    ...
    def test_talmud_section(self):
        ...
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Berakhot')
    ...
    def test_schema_node(self):
        ...
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Siddur Ashkenaz, Weekday')
    ...
    def test_deep_complex_segment(self):
        ...
        self.assertEqual(data['start_indexes'], [2])
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Siddur Ashkenaz, Weekday, Shacharit, Preparatory Prayers, Modeh Ani')
    ...
    def test_jagged_array_under_default_child(self):
        ...
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Ramban on Genesis')
    ...
    def test_dictionary_entry_node(self):
        ...
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'BDB')
    ...
    def test_dictionary_entry_segment(self):
        ...
        self.assertEqual(data['node_type'], 'DictionaryEntryNode')
        self.assertEqual(data['start_indexes'], [1])
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'BDB, אָב')
    ...
    def test_sheet_node(self):
        ...
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Sheet')
    ...
    def test_sheet_segment(self):
        ...
        self.assertEqual(data['node_type'], 'SheetNode')
        self.assertEqual(data['sheet_id'], 1)
        self.assertEqual(data['navigation_refs']['lineage_refs_top_down'][0], 'Sheet 1')
