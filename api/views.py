...
class Text(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        linker_debug = request.GET.get('linker_debug', '0') == '1'
        text_manager = TextRequestAdapter(self.oref, versions_params, fill_in_missing_segments, return_format, linker_debug)
