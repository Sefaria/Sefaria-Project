...
H=authpoc.cauldron.sefaria.org; A=(-H 'x-api-key: sfr_alpha000000000000000000000000001'); EG="kubectl --context gke_development-205018_us-east1-b_cluster-1 -n envoy-gateway-system"
