...
def test_make_text_index_document():
    ...
    # Matches TextIndexer.index_ref's own construction, the real migrated code path.
    content = TextChunk(oref, direction=get_direction_from_legacy_lang(lang), vtitle=vtitle).ja().flatten_to_string()
