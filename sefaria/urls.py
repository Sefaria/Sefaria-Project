...
urlpatterns += patterns('reader.views', 
    ...
    (r'^splash/?$', 'splash'),
    (r'^(contribute|educators|developers|donate|related-projects|copyright-policy|terms|privacy-policy|meetup1|meetup2)/?$', 'serve_static'),
)
