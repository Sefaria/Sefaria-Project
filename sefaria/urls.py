...
urlpatterns += patterns('reader.views', 
    ...
    (r'^splash/?$', 'splash'),
    (r'^metrics/?$', 'metrics'),
    (r'^(contribute|educators|developers|faq|donate|translation-guidelines|related-projects|jobs|copyright-policy|terms|privacy-policy|meetup1|meetup2)/?$', 'serve_static'),
)
