...
subscribe(marked_up_text_chunk.process_version_title_change_in_marked_up_text_chunks, text.Version, "attributeChange", "versionTitle")
subscribe(marked_up_text_chunk.process_version_title_change_in_linker_output,       text.Version, "attributeChange", "versionTitle")
