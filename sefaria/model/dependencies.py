...
# Index Name Change
subscribe(
    text.process_index_title_change_in_core_cache,
    text.Index,
    "attributeChange",
    "title",
)
subscribe(
    text.process_index_title_change_in_versions, text.Index, "attributeChange", "title"
)
subscribe(
    version_state.process_index_title_change_in_version_state,
    text.Index,
    "attributeChange",
    "title",
)
subscribe(
    link.process_index_title_change_in_links, text.Index, "attributeChange", "title"
)
subscribe(
    note.process_index_title_change_in_notes, text.Index, "attributeChange", "title"
)
subscribe(
    history.process_index_title_change_in_history,
    text.Index,
    "attributeChange",
    "title",
)
subscribe(
    text.process_index_title_change_in_dependant_records,
    text.Index,
    "attributeChange",
    "title",
)
subscribe(
    text.process_index_title_change_in_sheets, text.Index, "attributeChange", "title"
)
subscribe(
    cascade(notification.GlobalNotificationSet, "content.index"),
    text.Index,
    "attributeChange",
    "title",
)
subscribe(
    ref_data.process_index_title_change_in_ref_data,
    text.Index,
    "attributeChange",
    "title",
)
subscribe(
    user_profile.process_index_title_change_in_user_history,
    text.Index,
    "attributeChange",
    "title",
)
subscribe(
    topic.process_index_title_change_in_topic_links,
    text.Index,
    "attributeChange",
    "title",
)
subscribe(
    manuscript.process_index_title_change_in_manuscript_links,
    text.Index,
    "attributeChange",
    "title",
)
...
subscribe(
    cascade_delete(notification.GlobalNotificationSet, "content.index", "title"),
    text.Index,
    "delete",
)
    ...
    if SEARCH_INDEX_ON_SAVE:
        ...
        for ref in text_index.all_segment_refs():
            TextIndexer.index_ref(
                search_index_name, ref, kwargs.get("new"), ver.language, False
            )


# Version Title Change
subscribe(
    history.process_version_title_change_in_history,
    text.Version,
    "attributeChange",
    "versionTitle",
)
subscribe(
    process_version_title_change_in_search,
    text.Version,
    "attributeChange",
    "versionTitle",
)
subscribe(
    cascade(notification.GlobalNotificationSet, "content.version"),
    text.Version,
    "attributeChange",
    "versionTitle",
)
...
subscribe(
    cascade_delete(
        notification.GlobalNotificationSet, "content.version", "versionTitle"
    ),
    text.Version,
    "delete",
)
...
subscribe(
    cascade(schema.TermSet, "scheme"), schema.TermScheme, "attributeChange", "name"
)
...
# Time
subscribe(
    cascade(topic.PersonTopicSet, "properties.era.value"),
    timeperiod.TimePeriod,
    "attributeChange",
    "symbol",
)
subscribe(
    cascade(topic.PersonTopicSet, "properties.generation.value"),
    timeperiod.TimePeriod,
    "attributeChange",
    "symbol",
)
...
# Gardens
subscribe(
    cascade(garden.GardenStopSet, "garden"), garden.Garden, "attributeChange", "key"
)
subscribe(
    cascade_delete(garden.GardenStopSet, "garden", "key"), garden.Garden, "delete"
)
subscribe(
    cascade(garden.GardenStopRelationSet, "garden"),
    garden.Garden,
    "attributeChange",
    "key",
)
subscribe(
    cascade_delete(garden.GardenStopRelationSet, "garden", "key"),
    garden.Garden,
    "delete",
)
...
subscribe(
    cascade_delete(notification.NotificationSet, "global_id", "_id"),
    notification.GlobalNotification,
    "delete",
)
subscribe(
    cascade_delete(story.UserStorySet, "shared_story_id", "_id"),
    story.SharedStory,
    "delete",
)
...
# Collections
subscribe(
    collection.process_collection_slug_change_in_sheets,
    collection.Collection,
    "attributeChange",
    "slug",
)
subscribe(
    collection.process_collection_delete_in_sheets, collection.Collection, "delete"
)
subscribe(
    cascade_delete(notification.NotificationSet, "content.collection_slug", "slug"),
    collection.Collection,
    "delete",
)
...
# Categories
subscribe(
    category.process_category_name_change_in_categories_and_indexes,
    category.Category,
    "attributeChange",
    "lastPath",
)
subscribe(
    text.rebuild_library_after_category_change,
    category.Category,
    "attributeChange",
    "lastPath",
)
...
# Manuscripts
subscribe(
    manuscript.process_slug_change_in_manuscript,
