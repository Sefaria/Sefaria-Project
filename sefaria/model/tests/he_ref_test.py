...
class Test_parse_he_ref_range(object):
    def test_hebrew_range_simple(self):
        ...
        assert m.Ref("דברי הימים א ט״ו:ט״ו - דברי הימים א ט״ז:י״ז") == m.Ref(
            "I Chronicles 15:15-16:17"
        )
    ...
    def test_hebrew_range_commentary(self):
        assert m.Ref('רש"י על ויקרא ט״ו:ג׳-י״ז:י״ב') == m.Ref(
            "Rashi on Leviticus 15:3-17:12"
        )
