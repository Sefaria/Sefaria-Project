...
class Link(abst.AbstractMongoRecord):
    ...
    optional_attrs = [
        ...
        "expandedRefs",     # list combining `epxandedRefs0` and `expandedRefs1` used for searching
    ...
    def _set_expanded_refs(self):
        ...
        self.expandedRefs  = self.expandedRefs0 + self.expandedRefs1
...
class LinkSet(abst.AbstractMongoSet):
    ...
    def __init__(self, query_or_ref={}, page=0, limit=0):
        ...
        try:
            ...
            ref_clauses = [{"expandedRefs": {"$regex": r}} for r in regex_list]
            super(LinkSet, self).__init__({"$or": ref_clauses}, page, limit, hint=[("expandedRefs", 1)])
