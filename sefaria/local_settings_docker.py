...
#         "LOCATION": "redis://cache:6379/1", #The URI used to look like this "127.0.0.1:6379:0"
#         "OPTIONS": {
...
#     "default": {
#         "BACKEND": "django_redis.cache.RedisCache",
#         "LOCATION": "redis://cache:6379/0", #The URI used to look like this "127.0.0.1:6379:0"
#         "OPTIONS": {
#             "CLIENT_CLASS": "django_redis.client.DefaultClient",
...
SEARCH_ADMIN = "http://localhost:9300"
...
MULTISERVER_REDIS_SERVER = "localhost"
...
SENTRY_DSN = None #"https://0d374552ebde41659cf48738e8484d48@o4505401832243200.ingest.sentry.io/4505401833684992"
CLIENT_SENTRY_DSN = None # "https://87dd77e2991c48b4a69022eebb2e635f@o4505401832243200.ingest.sentry.io/4505402077675520"
...
# This is the key used to encrypt the user id in the plugin secret, convert it to bytes
