...
class Test_Jagged_Text_Array(object):
    ...
    def test_subarray(self):
        ...
        assert ja.JaggedTextArray(threeby).subarray(
            [1, 1, 1], [1, 2, 1]
        ) == ja.JaggedTextArray([["2:2", "2:3"], ["Third first", "Third second"]])
    ...
    def test_sections(self):
        ...
        assert ja.JaggedTextArray(threeby).sections() == [
            [0, 0],
            [0, 1],
            [0, 2],
            [1, 0],
    ...
    def test_trim_ending_whitespace(self):
        ...
        # do no harm
        assert ja.JaggedTextArray(twoby).trim_ending_whitespace() == ja.JaggedTextArray(
            twoby
        )
        assert ja.JaggedTextArray(
            threeby
        ).trim_ending_whitespace() == ja.JaggedTextArray(threeby)
        ...
        assert ja.JaggedTextArray(
            twoby_with_space
        ).trim_ending_whitespace() == ja.JaggedTextArray(twoby)
        assert ja.JaggedTextArray(
            threeby_with_space
        ).trim_ending_whitespace() == ja.JaggedTextArray(threeby)
    ...
    def test_resize(self):
        assert ja.JaggedTextArray(twoby).resize(1).resize(-1) == ja.JaggedTextArray(
            twoby
        )
    ...
    def test_flatten_to_string(self):
        ...
        assert (
            ja.JaggedTextArray(["Test", "More", "Test"]).flatten_to_string()
            == "Test More Test"
        )
