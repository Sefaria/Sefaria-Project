...
shared_patterns = [
    ...
    path('api/regexs/<path:titles>', sefaria_views.title_regex_api),
    path('api/websites/<path:domain>', sefaria_views.websites_api),
    path('api/linker-data/<path:titles>', sefaria_views.linker_data_api),
    path('api/bulktext/<path:refs>', sefaria_views.bulktext_api),
    path('api/text-upload', sefaria_views.text_upload_api),
    path('api/linker-track', sefaria_views.linker_tracking_api),
    path('api/guides/<str:guide_key>', guides_views.guides_api),
    path('admin/reset/varnish/<path:tref>', sefaria_views.reset_varnish),
    path('admin/reset/cache', sefaria_views.reset_cache),
    path('admin/reset/cache/<path:title>', sefaria_views.reset_index_cache_for_text),
    path('admin/reset/counts/all', sefaria_views.reset_counts),
    path('admin/reset/counts/<path:title>', sefaria_views.reset_counts),
    path('admin/reset/toc', sefaria_views.rebuild_toc),
    path('admin/reset/ac', sefaria_views.rebuild_auto_completer),
    path('admin/reset/api/<path:apiurl>', sefaria_views.reset_cached_api),
    path('admin/reset/community', reader_views.community_reset),
    path('admin/reset/<path:tref>', sefaria_views.reset_ref),
    ...
    path('admin/delete/sheet', sefaria_views.delete_sheet_by_id, name="delete/sheet"),
    path('admin/rebuild/auto-links/<path:title>', sefaria_views.rebuild_auto_links),
    path('admin/rebuild/citation-links/<path:title>', sefaria_views.rebuild_citation_links),
    re_path(r'^admin/rebuild/shared-cache', sefaria_views.rebuild_shared_cache),
    path('admin/delete/citation-links/<path:title>', sefaria_views.delete_citation_links),
    ...
    path('admin/spam', sefaria_views.spam_dashboard),
