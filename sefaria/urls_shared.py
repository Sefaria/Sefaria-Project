...
shared_patterns = [
    ...
    path('api/linker-admin/citation/delete', api_views.LinkerAdminDeleteCitationView.as_view()),
    path('api/linker-admin/citation/recreate', api_views.LinkerAdminRecreateCitationView.as_view()),
    path('api/linker-admin/citation/parse', api_views.LinkerAdminParseCitationView.as_view()),
    path('api/linker-admin/segment/rerun', api_views.LinkerAdminRerunSegmentView.as_view()),
