...
def ensure_indices():
    ...
    db.user_history.create_index("ref")
    db.user_history.create_index([("uid", pymongo.ASCENDING), ("server_time_stamp", pymongo.ASCENDING)])
    db.user_history.create_index([("uid", pymongo.ASCENDING), ("book", pymongo.ASCENDING), ("last_place", pymongo.ASCENDING)])
