...
def ensure_indices(active_db=None):
    ...
    indices = [
        ...
        (
            "links",
            [[("refs", pymongo.ASCENDING), ("generated_by", pymongo.ASCENDING)]],
            {},
        ),
        ("links", ["refs.0"], {}),
        ("links", ["refs.1"], {}),
        ...
        (
            "links",
            [[("owner", pymongo.ASCENDING), ("date_modified", pymongo.DESCENDING)]],
            {},
        ),
        ("texts", ["title"], {}),
        ...
        (
            "texts",
            [[("versionTitle", pymongo.ASCENDING), ("langauge", pymongo.ASCENDING)]],
            {},
        ),
        ...
        (
            "lexicon_entry",
            [[("headword", pymongo.ASCENDING), ("parent_lexicon", pymongo.ASCENDING)]],
            {},
        ),
        ("user_story", ["uid"], {}),
        (
            "user_story",
            [[("uid", pymongo.ASCENDING), ("timestamp", pymongo.DESCENDING)]],
            {},
        ),
        ...
        (
            "user_history",
            [[("uid", pymongo.ASCENDING), ("server_time_stamp", pymongo.ASCENDING)]],
            {},
        ),
        (
            "user_history",
        ...
        (
            "manuscript_pages",
            [[("manuscript_slug", pymongo.ASCENDING), ("page_id", pymongo.ASCENDING)]],
            {"unique": True},
        ),
        ("manuscripts", ["slug"], {}),
        ("manuscripts", ["title"], {}),
        (
            "messages",
            [[("room_id", pymongo.ASCENDING), ("timestamp", pymongo.DESCENDING)]],
            {},
        ),
        ("vstate", ["title"], {}),
